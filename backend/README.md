...
## Project Structure
    ...
    ├── app_creation_aline__35782  # Django project configurations
...
1. Clone this repo and `cd app_creation_aline__35782`
...
2. Clone this repo and `cd app_creation_aline__35782`
